...
//		root = (AnchorPane) FXMLLoader.load(getClass().getResource("/views/RegistView.fxml"));
		
		try {
			AnchorPane root = (AnchorPane) FXMLLoader.load(getClass().getResource("/views/RegistView.fxml"));
			Main.stage.setTitle("Regist View");
